...
const LiveChatWidget: React.FC<LiveChatWidgetProps> = ({
  ...
  return (
    <div className="fixed top-[82px] right-3 sm:right-10 no-print z-[2000] pointer-events-none animate-in slide-in-from-top-4 duration-300">
      <div className="bg-white dark:bg-stone-900 shadow-2xl border border-[#c5a065] p-5 rounded-[2.5rem] w-[calc(100vw-24px)] sm:w-80 max-h-[600px] flex flex-col pointer-events-auto">
